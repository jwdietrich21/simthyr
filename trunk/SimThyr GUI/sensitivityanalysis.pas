...
uses
  ...
  TADrawerCanvas, TANavigation, SimThyrTypes, SimThyrGUIServices,
  Predictor, SimThyrPrediction, UnitConverter, Types;
...
var
  ...
  StoredParameters: TParameterSpace;
...
begin
  StoredParameters.alphaR := alphaR;
  StoredParameters.betaR := betaR;
  ...
  StoredParameters.alphaS := alphaS;
  StoredParameters.betaS := betaS;
  StoredParameters.alphaS2 := alphaS2;
  StoredParameters.betaS2 := betaS2;
  StoredParameters.LS := LS;
  StoredParameters.SS := SS;
  StoredParameters.DS := DS;
  StoredParameters.alphaT := alphaT;
  StoredParameters.betaT := betaT;
  StoredParameters.GT := GT;
  StoredParameters.dT := dT;
  StoredParameters.alpha31 := alpha31;
  StoredParameters.beta31 := beta31;
  StoredParameters.alpha32 := alpha32;
  StoredParameters.beta32 := beta32;
  StoredParameters.k30 := k30;
  StoredParameters.k31 := k31;
  StoredParameters.k41 := k41;
  StoredParameters.k42 := k42;
  StoredParameters.Tt1 := Tt1;
  StoredParameters.Tt2 := Tt2;
  StoredParameters.Tt22 := Tt22;
  StoredParameters.Tt3 := Tt3;
  StoredParameters.Tt4 := Tt4;
...
begin
  alphaR := StoredParameters.alphaR;
  betaR := StoredParameters.betaR;
  ...
  alphaS := StoredParameters.alphaS;
  betaS := StoredParameters.betaS;
  alphaS2 := StoredParameters.alphaS2;
  betaS2 := StoredParameters.betaS2;
  LS := StoredParameters.LS;
  SS := StoredParameters.SS;
  DS := StoredParameters.DS;
  alphaT := StoredParameters.alphaT;
  betaT := StoredParameters.betaT;
  GT := StoredParameters.GT;
  dT := StoredParameters.dT;
  alpha31 := StoredParameters.alpha31;
  beta31 := StoredParameters.beta31;
  alpha32 := StoredParameters.alpha32;
  beta32 := StoredParameters.beta32;
  k30 := StoredParameters.k30;
  k31 := StoredParameters.k31;
  k41 := StoredParameters.k41;
  k42 := StoredParameters.k42;
  Tt1 := StoredParameters.Tt1;
  Tt2 := StoredParameters.Tt2;
  Tt22 := StoredParameters.Tt22;
  Tt3 := StoredParameters.Tt3;
  Tt4 := StoredParameters.Tt4;
