...
uses
  Classes, SysUtils, UnitConverter
  {$IFDEF GUI}, Forms, Graphics, TAGraph
  {$ENDIF};
...
const
 ...
 SimThyr_release = 6;
 SimThyr_patch   = 0;
 SimThyr_fullversion = ((SimThyr_major * 100 + SimThyr_minor) *
    100 + SimThyr_release) * 100 + SimThyr_patch;
 SimThyr_version = '4.0.6.0';
 SimThyr_internalversion = 'Merlion';
...
var
 nmax_old, tmax, lt, gridrows: integer;
 nmax, factor, i0: longint;
 ...
 delt: real;
 previewflag, noiseflag, circadianflag: boolean;
