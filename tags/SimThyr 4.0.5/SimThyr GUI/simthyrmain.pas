...
uses
  ...
  ShowAboutModel, StructureParameters, Predictor, SimThyrPrediction,
  Sensitivityanalysis, TWSensitivityanalysis, tornado, Equilibriumdiagram,
  help, ScenarioHandler, HandlePreferences, HandleNotifier, LCLProc, StdCtrls,
  LCLVersion, EnvironmentInfo, MIRIAMForm;
